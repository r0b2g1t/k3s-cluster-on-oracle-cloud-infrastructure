...
The general process looks like as follows. For simplicity, I will refer to server-0, server-1, agent-0 and agent-1 and node 1, node 2, node 3 and node 4 respectively.
